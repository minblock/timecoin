...
"""Verify that starting timecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start timecoin with -h for help text")
        ...
        self.log.info("Start timecoin with -version for version information")
        ...
        self.log.info("Start timecoind with -fakearg to make sure it does not start")
