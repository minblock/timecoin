# Support for Output Descriptors in timecoin Core

Since timecoin Core v0.17, there is support for Output Descriptors. This is a
...
on timecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing timecoin Core wallets, a convenience function `combo` is
