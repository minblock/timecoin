...
const char * const BITCOIN_CONF_FILENAME = "timecoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "timecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/timecoin";
#else
    // Unix
    return pathRet / ".timecoin";
#endif
#endif
}
