...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " timecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  timecoin-tx [options] <hex-tx> [commands]  Update hex-encoded timecoin transaction\n" +
            "or:     timecoin-tx [options] -create [commands]   Create hex-encoded timecoin transaction\n" +
            "\n";
